...
//                console.log("finds");
    ...
    breakFloor: function(i){
        ...
        console.log("lg"+i+","+this.parentArray[i].length);
         //落下処理
//.delay(this.parentArray[0].length - this.arrayNumX)
//        this.tl.moveBy(0,-10,0, 20, enchant.Easing.QUAD_EASEIN).then(function(){
                //床キューブ配列から自身を削除
...
//            })
//            .then(function(){
                this.parentArray[this.arrayNumX].pop();//床面配列から自身を削除
                console.log("lga2"+this.parentArray[i].length);
//            });       
    }
